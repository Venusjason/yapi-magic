...
<link rel="stylesheet" href="http://statics-cdn.weierai.com/libs/element-ui/2.12.0/index.css">
<style>
  body {
    padding: 0 50px 50px;
  }
...
<body>
  ...
  <script src="http://statics-cdn.weierai.com/libs/vue/2.6.10/vue.min.js"></script>
  <script src="http://statics-cdn.weierai.com/libs/element-ui/2.12.0/index.js"></script>
  <div id="app">
    <h2>API接口变更统计</h2>
    <el-row>
      <el-col :span="24">
