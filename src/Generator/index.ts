...
import { jsonSchemaStringToJsonSchema, jsonSchemaToType, jsonToJsonSchema, mkdirs, mockjsTemplateToJsonSchema, propDefinitionsToJsonSchema, resolveApp, writeFileSync } from './../utils'
    ...
    try {
      ...
      outputs.forEach((api, i) => {
        ...
        if (i === outputs.length - 1) {
          ...
          consola.log('===================================================')
          consola.warn(`共计更新了${addeds.length + deleteds.length + modifieds.length}个接口文件，请到git工作区比对文件更新`)
